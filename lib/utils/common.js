...
export default new class nccommon {
     ...
     * @param args
     */
    info(botInfo = { nickname: '未连接', uin: '未连接' }, ...args) {
     ...
     * @param args
     */
    mark(botInfo = { nickname: '未连接', uin: '未连接' }, ...args) {
     ...
     * @param args
     */
    warn(botInfo = { nickname: '未连接', uin: '未连接' }, ...args) {
     ...
     * @param args
     */
    error(botInfo = { nickname: '未连接', uin: '未连接' }, ...args) {
     ...
     * @param args
     */
    debug(botInfo = { nickname: '未连接', uin: '未连接' }, ...args) {
